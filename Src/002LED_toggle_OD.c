 ...
 *
 * @details
 * this application demonstrates basic GPIO output functionality in OPEN-
 * DRAIN configuration using the custom GPIO driver to target an LED on
...
int main(void){
	...
	gpio_led.GPIO_PinConfig.outType = GPIO_OTYPE_OD;
	gpio_led.GPIO_PinConfig.puPdCtl  = GPIO_PIN_PU;		// led will be very dim since pull-up resistor is around 40Kohms
